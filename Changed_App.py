...
def user_input(user_question):
    ...
    if not os.path.exists("faiss_index"):
        st.error("Vector store not found. Please create the vector store first.")
        return
...
def main():
    ...
    st.write("The PDF uploading option has been removed. Please ensure that the vector store (faiss_index) is already created.")
